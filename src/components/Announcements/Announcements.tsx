    ...
    <Layout title="Our Announcements">
      ...
      <div className="w-full h-96">
        <div className="relative w-full h-96">
          <img
            src={new URL("../../assets/img/banner_ann.jpg", import.meta.url).href}
      ...
      <Container maxWidth="lg">
        <div className="flex flex-col items-center justify-start w-full px-2 mt-2 md:px-16 md:mt-24 md:flex-row md:items-start">
