import { IAnnouncementsData } from "../../../data/announcements";
...
const Card = ({ announcement }: ICardProps) => {
  const { id, title, short_description, image } = announcement;
  return (
    <div className="flex flex-col p-6 my-4 max-w-7xl md:flex-row md:justify-around">
      ...
      <div className="pl-6 md:w-2/3 md:">
        <div className="flex flex-col items-center justify-center">
          ...
          <p className="text-lg leading-8 font-skModernist">{short_description}.</p>
          <p className="text-lg leading-8 font-skModernist">{short_description}</p>
        </div>
      </div>
    </div>
